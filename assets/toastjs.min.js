...
Toast.prototype._addEventListeners = function () {
    var _this2 = this;
    if(document.querySelector('.toastjs-btn--close')){
        document.querySelector('.toastjs-btn--close').addEventListener('click', function () {
            _this2._close();
        });
    }

    document.querySelector('.toastjs').addEventListener('click', function(){
        _this2._close();
    });

    setTimeout(function(){
        console.log('create elements',  _this2.duration)
        setTimeout(function(){
            _this2._close();
        },  _this2.duration)
...
Toast.prototype._open = function () {
    ...
    if(this.options.showCloseButton){
        this.toastEl.innerHTML += '<button type="button" class="toastjs-btn toastjs-btn--close">Cerrar</button>\n';
    
        this.focusedElBeforeOpen = document.activeElement;
        document.querySelector('.toastjs-btn--close').focus();
    }

    this.toastEl.innerHTML += customButtons + '\n    ';
